                                        ...
                                        <div className="row mb-5 justify-content-center">
                                                        <div className="mt-1 col-12 col-lg-5" id="Bloque_ajustes">
                                                                ...
                                                                <div className="form-group">
                                                                     ...
                                                                     />
                                                                     <label for="name" className="form-label">Nombre farmacia</label>
                                                                ...
                                                                <div className="row justify-content-center mt-0" to="/Ajustes">
                                                                        <Link className="col-lg-10 col-10 btn btn-dark btn-block" type="submit"  to="/Ajustes_f" id="btn_solicitar" alert="">Aceptar</Link>
                                                                </div>
                                                                <div className="mt-3"></div>
                                                                <div className="row justify-content-center mt-0" to="/Ajustes">
