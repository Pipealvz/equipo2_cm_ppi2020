...
export default function Inicio_sesion() {
        ...
        axios.post('https://equipo2cmppi2020-2.felipealvarez8.repl.co/api/farmacia',loginUser)
                .then(()=> {
                        ...
                        <div className="container vh-100" id="container">
                                <div className="row vh-100 justify-content-end">
                                        <div className="col-12 col-lg-4 align-self-center" id="Bloque_inicio">
                                                ...
                                                <h1 className="text-center mt-4" id="Texto_inicio">Iniciar Sesión como farmacia</h1>
                                                <hr />
                                                <br />
                                                <form onSubmit={eventoRegistrar} method="post" name="Loginform">
                                                        ...
                                                        <Link id="link" to="/Solicitud_f">
                                                                <button className=" btn btn-dark btn-block mt-0"  type="submit" id="btn_inicio">
                                                                        <strong>Iniciar sesión</strong>
                                                                </button>
                                                                <hr />
                                                        </Link>
                                                        <span className="link-registro">¿No estás registrado como farmacia? <Link id="link" to="/Registro.farmacia">¡Registrate!</Link>
                                                        </span>
                                                        <div className="row"></div>
                                                        <span className="link-farmacia">¿Eres un usuario? <Link id="link" to="/">¡Inicia sesión!</Link>
                                                        </span>
                                                </form>
                                                <br />
                                        </div>
